...
const SideImageContainer = ({
  ...
  return (
    <div className={`${className} mx-auto h-[80vh] w-full flex flex-col lg:flex-row lg items-center justify-between p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md`}>
