...
import { Input, SideImageContainer } from '../../component'
...
const SignUp = () => {
  ...
  return (
    <div>
      <Container>
        <SideImageContainer imageUrl='./signin-image.webp' className={'w-[75%]'}>
          <div className="w-full p-10">
            ...
            <div class="space-x-6 flex justify-center mt-6">
              <Button
                type="button"
                class="border-none outline-none opacity-80 hover:opacity-100">
